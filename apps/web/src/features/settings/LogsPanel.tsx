      ...
      {rows !== null && rows.length === 0 && !error && (
        <Empty className="border">
          <EmptyHeader>
            ...
            <EmptyDescription>
              No automation runs match these filters. Try a different email, or clear the filters to
              see the latest runs.
            </EmptyDescription>
          </EmptyHeader>
        </Empty>
    ...
    <div>
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <p className="text-xs text-muted-foreground">
          Instance search and the dead-letter queue — find where a contact is stuck.
        </p>
